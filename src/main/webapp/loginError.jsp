...
<body  onload="document.getElementById('j_idt21').focus();">
	<table style="width: 100%">
		...
		<tr>
			<td height="20" colspan="2">
				<div id="j_idt8:j_idt9" align="center">
					<ul id="j_idt8:j_idt9_menu">
						<p style="text-align:center;font-weight:400;">
							<span class="wijmo-wijmenu-text"><font color="#555555"> ERROR DE LOGIN</font></span>
						</p>
					</ul>
		...
		<tr valign="top">
			<td height="150" colspan="2" align="center">				 
				...
				<table id="error" align="center">
					<tbody>
						<tr>
							<td>Nombre de Usuario o Contraseña Incorrecta</td>
						</tr>
						<tr>
							<td>
								<div class="ui-toolbar-group-right" align="center">
